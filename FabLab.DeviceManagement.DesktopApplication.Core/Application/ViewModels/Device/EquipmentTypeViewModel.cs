...
#pragma warning restore CS8601 // Possible null reference assignment.
        ...
        public bool FirstLoading { get; set; }
        ...
        private async void LoadEquipmentTypeEntries()
        {
            ...
            try
            {
                    ...
                    && String.IsNullOrEmpty(TagId))
                {
                    ...
                    IsSearch = true;
                    filteredEquipmentTypes = (await _apiService.GetAllEquipmentTypesAsync()).ToList();
                    IsSearch = false;
...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
        ...
        public void AddSpec()
        {
            ...
            {
                var spec = new SpecificationEquimentType()
                {
                    name = NewName,
                    unit = NewUnit,
                    value = NewValue,
                ...
                SpecificationEquimentTypes.Add(spec);
                NewSpecificationEquimentTypes.Add(spec);
            }
        ...
        {
            SpecificationEquimentTypes.Clear();
            NewSpecificationEquimentTypes.Clear();
